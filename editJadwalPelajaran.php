                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="needs-validation" novalidate="" method="POST" action="./controller/jadwalPelajaran/update.php">
                                       <?php
                                       $getData = mysqli_query($conn, "SELECT * FROM jadwal_pelajaran WHERE id = '$idJadwal'");
                                       while ($dataJadwal = mysqli_fetch_array($getData)) {
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select class=" wide form-control" id="validationCustom05" name="jam_pelajaran">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $data["id"] ?>" <?php if ($dataJadwal['waktu']==$data['id']) {
                                                                echo 'selected';
                                                            }?>><?php echo $data["jam_pelajaran"] ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                              ...
                                              <div class="mb-3">
                                                ...
                                                <select class=" wide form-control" id="validationCustom05" name="senin">
                                                    ...
                                                    while ($dataSenin = mysqli_fetch_array($ambilDataKelas)) {
                                                    ?>
                                                        <option value="<?php echo $dataSenin["mapel"] ?>" <?php if ($dataJadwal['senin'] == $dataSenin['mapel']) {
                                                            echo 'selected';
                                                        } ?>><?php echo $dataSenin["mapel"] ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                              ...
                                              <div class="mb-3">
                                                    ...
                                                    <select class=" wide form-control" id="validationCustom05" name="selasa">
                                                        ...
                                                        while ($data = mysqli_fetch_array($ambilDataKelas)) {
                                                        ?>
                                                            <option value="<?php echo $data["mapel"] ?>" <?php if ($dataJadwal['selasa'] == $data['mapel']) {
                                                            echo 'selected';
                                                        } ?>><?php echo $data["mapel"] ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                              ...
                                              <div class="mb-3">
                                                    ...
                                                    <select class=" wide form-control" id="validationCustom05" name="rabu">
                                                        ...
                                                        while ($data = mysqli_fetch_array($ambilDataKelas)) {
                                                        ?>
                                                            <option value="<?php echo $data["mapel"] ?>" <?php if ($dataJadwal['rabu'] == $data['mapel']) {
                                                            echo 'selected';
                                                        } ?>><?php echo $data["mapel"] ?></option>
                                                        <?php
                                                        }
                                              ...
                                              <div class="mb-3">
                                                    ...
                                                    <select class=" wide form-control" id="validationCustom05" name="kamis">
                                                        ...
                                                        while ($data = mysqli_fetch_array($ambilDataKelas)) {
                                                        ?>
                                                            <option value="<?php echo $data["mapel"] ?>" <?php if ($dataJadwal['kamis'] == $data['mapel']) {
                                                            echo 'selected';
                                                        } ?>><?php echo $data["mapel"] ?></option>
                                                        <?php
                                                        }
                                              ...
                                              <div class="mb-3">
                                                    ...
                                                    <select class=" wide form-control" id="validationCustom05" name="jumat">
                                                        ...
                                                        while ($data = mysqli_fetch_array($ambilDataKelas)) {
                                                        ?>
                                                            <option value="<?php echo $data["mapel"] ?>" <?php if ($dataJadwal['jumat'] == $data['mapel']) {
                                                            echo 'selected';
                                                        } ?>><?php echo $data["mapel"] ?></option>
                                                        <?php
                                                        }
                                              ...
                                              <div class="mb-3">
                                                    ...
                                                    <select class=" wide form-control" id="validationCustom05" name="sabtu">
                                                        ...
                                                        while ($data = mysqli_fetch_array($ambilDataKelas)) {
                                                        ?>
                                                            <option value="<?php echo $data["mapel"] ?>" <?php if ($dataJadwal['sabtu'] == $data['mapel']) {
                                                            echo 'selected';
                                                        } ?>><?php echo $data["mapel"] ?></option>
                                                        <?php
                                                        }
                                              ...
                                              <div class="col-md-4">
                                                  <div class="form-check custom-checkbox mb-3 checkbox-success">
                                                      <input type="checkbox" class="form-check-input" id="customCheckBox3" name="istirahat" <?php if ($dataJadwal['sabtu'] == 'istirahat') {
                                                            echo 'checked';
                                                        } ?> value="istirahat">
