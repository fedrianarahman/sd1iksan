...
$ambilDataSikapAbsensi = mysqli_query($conn, "SELECT raport.sakit AS siswa_sakit, raport.izin AS siswa_izin, raport.alfa AS siswa_alpha, raport.sikap_sosial AS sikap_sosial, raport.sikap_spritual AS sikap_spritual,raport.saran AS saran,raport.tbs1 AS tbs1, raport.tbs2 AS tbs2,raport.bbs1 AS bbs1,raport.bbs2 AS bbs2 FROM raport WHERE idSiswa = '$id_siswa' GROUP BY idSiswa");
...
<tr>
   ...
   <td colspan="3">'.$dataSikapAbsensi['sikap_spritual'].'</td>
</tr>
<tr>
   <td class="bold">2.Sikap Sosial</td>
   <td colspan="3">'.$dataSikapAbsensi['sikap_sosial'].'</td>
</tr>
...
<table>
    ...
    while ($dataNilai = mysqli_fetch_array($ambilDataNilai)) {
        ...
        <tr >
            ...
            <td class="deskripsi">'.$dataNilai['deskripsi_nilai_keterampilan'].'</td>
            <td class="nilai">'.$dataNilai['nilai_pelajaran'].'</td>
            <td class="nilai">'.$nilaiPelajaran.'</td>
            <td class="deskripsi">'.$dataNilai['deskripsi_nilai_pelajaran'].'</td>
        </tr>';
...
<div class="saran" style="border: 1px solid #000">
    <p style="text-indent: 15px;">'.$dataSikapAbsensi['saran'].'</p>
</div> ';
...
<tr>
    <td>1</td>
    <td>Tinggi Badan</td>
    <td>'.$dataSikapAbsensi['tbs1'].' cm</td>
    <td>'.$dataSikapAbsensi['tbs2'].' cm</td>
</tr>
<tr>
    <td>2</td>
    <td>Berat Badan</td>
    <td>'.$dataSikapAbsensi['bbs1'].' kg</td>
    <td>'.$dataSikapAbsensi['bbs2'].' kg</td>
</tr>
</table>';
...
<tr>
<td class="keputusan">NAIK Kelas</td>
</tr>
</table>';
$html27='<p>Mengetahui 
Orang Tua/Wali</p>';
