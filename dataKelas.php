...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>SDN 01 Leuwiliang| Data Kelas</title>
                    ...
                    <div class="alert alert-success solid alert-end-icon alert-dismissible fade show">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary" href="./addKelas.php">Tambah</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="./editKelas.php?id_kelas=<?php echo $data['id'] ?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                            <a href="./controller/kelas/delete.php?id_kelas=<?php echo $data['id'] ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
