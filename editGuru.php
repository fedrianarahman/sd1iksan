                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="needs-validation" novalidate="" method="POST" action="./controller/guru/update.php">
                                        <?php
                                        $ambilDataGuru = mysqli_query($conn, "SELECT * FROM user WHERE id = '$idGuru'");
                                        $dataGuru = mysqli_fetch_array($ambilDataGuru);
                                        ?>
                                    <div class="row">
												<div class="col-lg-6 mb-2">
													<div class="mb-3">
														<label class="text-label form-label">Nama</label>
														<input hidden type="text" name="id_guru" class="form-control" placeholder="nama guru" required="" value="<?php echo $dataGuru['id']?>">
                                                        <input type="text" name="nama" class="form-control" placeholder="nama guru" required="" value="<?php echo $dataGuru['nama']?>">
													</div>
												</div>
												<div class="col-lg-6 mb-2">
													<div class="mb-3">
                                                ...
                                                <div class="col-lg-6 mb-2">
													<div class="mb-3">
                                                        ...
                                                        required=""
                                                        value="<?php echo $dataGuru['username']?>">
													</div>
												</div>
                                                <div class="col-lg-6 mb-2">
													<div class="mb-3">
                                                        ...
                                                        required=""
                                                        value="<?php echo $dataGuru['password']?>">
													</div>
												</div>
